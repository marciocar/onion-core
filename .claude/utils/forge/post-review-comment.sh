...
#   .claude/utils/forge/interface.md   — `addReviewComment(prRef, comment)`
#   .claude/utils/forge/types.md       — `ReviewCommentInput { body, path?, line? }`
#   .claude/utils/forge/adapters/github.md — os dois transportes
#
