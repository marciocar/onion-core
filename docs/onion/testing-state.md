...
|---|---:|---|
| Famílias na bancada | **180** | `bash .claude/validation/harness-inventory.sh --env` |
| Sítios de asserção (estáticos) | **1095** | `bash .claude/validation/harness-inventory.sh --env` |
