...
**Regra dura:** guarda ou artefato que **viaja** (mora em `.claude/validation/` e entra no manifesto
...
Isto é o corolário empírico da [regra de admissão](inference-mitigation.md): o ponto cego "cláusula
